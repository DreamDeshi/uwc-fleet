...
const styles = StyleSheet.create({
  ...
  headerSub: { color: "rgba(255,255,255,0.6)", fontSize: 13, marginTop: 8 },
  progressWrap: { paddingHorizontal: 20, paddingTop: 16 },
  progressTrack: { flexDirection: "row", gap: 6 },
  progressBar: { flex: 1, height: 4, borderRadius: 2 },
  progressLabel: { fontSize: 12, color: "#888", fontWeight: "600", marginTop: 6 },
  ...
  noticeText: { flex: 1, fontSize: 12, color: colors.blue, fontWeight: "600" },
  ...
  error: { color: colors.red, fontSize: 13, marginTop: 16, fontWeight: "600" },
  bottom: {
