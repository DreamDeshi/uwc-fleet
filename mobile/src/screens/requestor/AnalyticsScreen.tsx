...
const styles = StyleSheet.create({
  ...
  cardSub: { fontSize: 12.5, color: colors.textMuted, marginBottom: 6 },

  monthLabels: { flexDirection: "row", marginTop: 8, paddingHorizontal: 4 },
  monthCol: { flex: 1, alignItems: "center" },
  monthCount: { fontSize: 12, fontWeight: "800", color: colors.navy },
  monthLabel: { fontSize: 11, color: colors.textMuted, marginTop: 1 },

  statusRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 12 },
  statusLabel: { fontSize: 12.5, color: colors.navy, fontWeight: "600", width: 86 },
  ...
  statusValue: { fontSize: 13, fontWeight: "800", color: colors.navy, width: 26, textAlign: "right" },
  ...
  rankText: { fontSize: 12, fontWeight: "800", color: colors.blue },
  destName: { flex: 1, fontSize: 14, fontWeight: "600", color: colors.navy },
  destCount: { fontSize: 12.5, fontWeight: "700", color: colors.textMuted },

  totalPalletsBox: { alignItems: "center", paddingVertical: 6 },
  totalPalletsValue: { fontSize: 34, fontWeight: "900", color: colors.blue },
  totalPalletsLabel: { fontSize: 11, fontWeight: "700", color: colors.textMuted, textTransform: "uppercase", letterSpacing: 0.5, marginTop: 2 },
  ...
  sizeName: { fontSize: 12.5, fontWeight: "700", color: colors.blue },
  sizeCount: { fontSize: 12.5, fontWeight: "800", color: colors.navy, backgroundColor: colors.white, borderRadius: 999, paddingHorizontal: 7, overflow: "hidden" },
  ...
  approvalSub: { fontSize: 12.5, color: colors.textMuted, marginTop: 1 },

  emptyBox: { alignItems: "center", paddingVertical: 26, gap: 8 },
  emptyTitle: { fontSize: 16, fontWeight: "800", color: colors.navy },
  emptyHint: { fontSize: 13.5, color: colors.textMuted, textAlign: "center", lineHeight: 20, paddingHorizontal: 12 },
});
