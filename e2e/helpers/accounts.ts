...
export const DRIVER: Account = { phone: "+60100000101", password: "Password123" }; // Azmi / PLX 2406
export const REQUESTOR: Account = { phone: "+60199990001", password: "Password123" };

// Azmi's assigned truck. The /approve endpoint requires truck_plate to match the
