...
async function seedZones() {
  ...
  // Johor (JH) & Selangor (SL) were placeholder "extension" zones (8-point,
  // matching KL) added so speculative JH/SL bookings would score during testing.
  // Mr. Teh confirmed 16 Jul 2026 they won't be used ("we wont arrange to Johor
  // and Selangor using this apps"), so they were removed 18 Jul 2026 — from the
  // spec's extensions block, here, and via migration for any already-seeded rows.
  console.log(
